...
define config.name = _("The Sakura Picnic")
...
define build.name = "fukushima_novel"
...
define config.main_game_transition = Fade(2, 3, 1)
...
define config.save_directory = "fukushima_novel-1740063957"
