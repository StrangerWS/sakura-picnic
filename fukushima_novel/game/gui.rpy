...
define gui.main_menu_background = "res/gui/main_menu.png"
define gui.game_menu_background = "res/gui/game_menu.png"
...
## Кнопки ######################################################################
##
## Эти переменные, вместе с файлами изображений в res/gui/button, контролируют
...
## описывающий слот сохранения. Слот сохранения использует файлы из res/gui/button,
